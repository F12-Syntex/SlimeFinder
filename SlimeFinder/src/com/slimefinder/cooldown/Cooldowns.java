...
import com.slimefinder.placeholder.time.TimeData;
import com.slimefinder.utils.MappyHelper;
import com.slimefinder.utils.MappyObject;

public class Cooldowns {

	public static Cooldowns instance;
	
	public FileConfiguration config = SlimeFinder.getInstance().configManager.getConfig("cooldown").configuration;
